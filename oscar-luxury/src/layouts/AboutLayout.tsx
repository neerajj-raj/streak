    ...
    <html dir="ltr" lang="en" className="font-primary font-secondary">
      ...
      <body className="antialiased min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          ...
          <WidgetPlaceholder id="AboutDescription" type="AboutDescription" />
          <WidgetPlaceholder id="AboutWhyChoose" type="AboutWhyChoose" />
          <WidgetPlaceholder id="HomeTestimonials" type="HomeTestimonials" />
          <WidgetPlaceholder id="AboutClients" type="AboutClients" />
        </main>
