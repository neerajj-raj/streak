        ...
        <div className="white-box-sec flex">
          {
            blogs?.map((blog, index) => (
              <div key={blog?.slug} className="white-box-section two-width aos-init" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={(index + 1) * 100}>
                ...
                <div className="white-box-content">
                  ...
                  <div className="right-link">
                    <a href={`/blog/${blog?.slug}`} className="line-btn blue">
                      Read More
                      <p style={{ display: "none" }}>{`learn more about ${blog?.title}`}</p>
