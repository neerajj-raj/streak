...
const BlogLists = (props: BlogListsProps) => {
  const { blog_posts, main_heading } = props?.data || {};
        ...
        <div className="container">
          ...
          <div className="white-box-sec flex">
            {blog_posts.map((post, i) => (
              <div
                className="white-box-section three-width"
                key={post.id}
                data-aos="fade-up"
                data-aos-duration="1000"
              ...
              >
                <a href={`/blog/${post.slug}`}>
                  <img src={post?.acf?.blog_list_image} alt={post.title} />
                  <div className="white-box-content">
                    <h3>{post.title}</h3>
                    <span dangerouslySetInnerHTML={{ __html: post?.acf?.blog_list_expert_content }} />
                    <div className="right-link">
                      <a href={`/blog/${post.slug}`} className="line-btn blue">
                        Read More
