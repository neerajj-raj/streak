export default async (request, context) => {
  ...
  const streakRefererPaths = [
    "/",
    "/about",
    "/about/",
    "/assets/js/asset-worker.js",
  ];
  const streakConfiguredPathNames = ["/", "/about", "/about/"];
  ...
  // Serve to Streak.js
  if (
    streakConfiguredPathNames.includes(url?.pathname) ||
    (isAsset && streakRefererPaths?.includes(refererUrl?.pathname ?? "")) ||
